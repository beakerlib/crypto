...
FILES=$(METADATA) runtest.sh lib.sh Makefile rstrnt-package-workaround.sh
...
$(METADATA): Makefile
	...
	@echo "RhtsRequires:    coreutils crypto-policies crypto-policies-scripts fips-mode-setup" >> $(METADATA)
